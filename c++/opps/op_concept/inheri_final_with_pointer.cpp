...
int main(){
    Tea* tea1 = new GreenTea(2); // build in dynamic memory
    Tea* tea2 = new MasalaTea(5);
    // -> this arrow tell from this location forward if you get any of this var function class plese call it or use it 
    tea1->Brew();
    tea1->serve();
    tea2->Brew();
    tea2->serve();
    // now if you create a D memory you should also delete it 
    delete tea1;
    delete tea2;
